...
class JackTokenizer_4 {
    ...
    func tokenType() -> tokType_4 {
        if isSymbol(token: currentToken) {
            return tokType_4.T_SYMBOL
        }
        if isKeyword(token: currentToken) {
            return tokType_4.T_KEYWORD
        }
        if currentToken.first! == "\"" {
            return tokType_4.T_STRING_CONST
        }
        if Int(currentToken) != nil {
            return tokType_4.T_INT_CONST
        }
        return tokType_4.T_IDENTIFIER
    }
